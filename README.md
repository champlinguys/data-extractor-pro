...
required. The latest version is **v0.7.2**.

**GUI** (Qt and OpenSSL are bundled in, so there are no dependencies to install):
```sh
wget https://github.com/champlinguys/data-extractor-pro/releases/download/v0.7.2/DataExtractorPro-x86_64.AppImage
...
**Headless CLI**:
```sh
wget https://github.com/champlinguys/data-extractor-pro/releases/download/v0.7.2/de-cli-linux-x86_64.tar.gz
